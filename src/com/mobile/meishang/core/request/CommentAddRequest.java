...
public class CommentAddRequest implements LoaderManager.LoaderCallbacks<Head> {

	private MActivity mActivity;

	public CommentAddRequest(MActivity activity) {
	...
	public Loader<Head> onCreateLoader(int arg0, Bundle bundle) {
		...
		urlString.append("comment/save.htm");
		DefaultNetworkRequest mHttpRequest = new DefaultNetworkRequest(
				urlString.toString());
		mHttpRequest.addPostParameter("context", bundle.getString("context"));
		mHttpRequest.addPostParameter("moduleid", bundle.getString("moduleid"));
		mHttpRequest.addPostParameter("smoduleid", bundle.getString("smoduleid"));
