...
public class ProvinceRequest implements
		LoaderManager.LoaderCallbacks<ModuleList> {

	private MFragment mFragment;
	private MActivity mActivity;

	public ProvinceRequest(MActivity activity) {
		this.mActivity = activity;
	}

	public ProvinceRequest(MFragment fragment) {
	...
	public Loader<ModuleList> onCreateLoader(int arg0, Bundle bundle) {
		...
		urlString.append("province/listProvince.htm");// 竞标页面
