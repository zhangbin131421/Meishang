...
public class InsideActivityLoader extends HttpRequestLoader<InsideActivityData> {

	public InsideActivityLoader(Context context, ZLNetworkRequest _HttpRequest) {
		super(context, _HttpRequest);
	}

	@Override
	public InsideActivityData handle(String content) throws ZLNetworkException {
		try {
			JSONObject jsonObject = new JSONObject(content);
			InsideActivityData data = new InsideActivityData(jsonObject);
			return data;
