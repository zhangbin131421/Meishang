...
public class MMyWordsLoader extends HttpRequestLoader<MyWords> {

	public MMyWordsLoader(Context context,
			ZLNetworkRequest _HttpRequest) {
		super(context, _HttpRequest);
	}

	@Override
	public MyWords handle(String content) throws ZLNetworkException {
		try {
			return new MyWords(new JSONObject(content) );
