...
public class PullRefreshLayout extends ViewGroup {
	...
	public PullRefreshLayout(Context context, AttributeSet attrs) {
		...
		final int type = a.getInteger(R.styleable.PullRefreshLayout_type,
				STYLE_MATERIAL);
		...
		// mRefreshDrawable.setColorSchemeColors(new int[]{Color.rgb(0xC9, 0x34,
		// 0x37), Color.rgb(0x37, 0x5B, 0xF1), Color.rgb(0xF7, 0xD2, 0x3E),
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		// mRefreshView.measure(MeasureSpec.makeMeasureSpec(mRefreshViewWidth,
		// MeasureSpec.EXACTLY), MeasureSpec.makeMeasureSpec(mRefreshViewHeight,
		// MeasureSpec.EXACTLY));
	}
	...
	protected void onLayout(boolean changed, int l, int t, int r, int b) {
		...
		// mRefreshView.layout(width / 2 - mRefreshViewWidth / 2,
		// -mRefreshViewHeight + mCurrentOffsetTop, width / 2 +
		// mRefreshViewHeight / 2, mCurrentOffsetTop);
