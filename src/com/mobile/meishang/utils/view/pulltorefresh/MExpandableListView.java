...
public class MExpandableListView extends ExpandableListView implements
		OnScrollListener {
	// private static final String TAG = "MExpandableListView";
	 ...
	 * (non-Javadoc)
	 * 
	 * @see android.widget.ExpandableListView#setAdapter(android.widget.
	 ...
	 * @param listener
	 */
	public void setXListViewListener(MOnRefreshListener listener) {
	...
	private void loadMore() {
		if (mEnablePullLoad && null != mRefreshListener) {
