...
public class XListView extends ListView implements OnScrollListener {
	...
	private int mLastFirstVisibleItem = -1;// slidingUp
	...
	public boolean onTouchEvent(MotionEvent ev) {
		// System.out.println(ev.getRawY() + "onTouchEventon" + ev.getAction());
		if (mLastY == -1) {
			mLastY = ev.getRawY();
		}
	...
	public void onScroll(AbsListView view, int firstVisibleItem,
		...
		// System.out.println("positiveNumber" + mLastFirstVisibleItem
		...
		if (mLinearLayout != null) {
			boolean ishow = mLinearLayout.isShown();
			int deltaY = mLastFirstVisibleItem - firstVisibleItem;
			if (deltaY < 0) {
				if (firstVisibleItem == 2 && (!ishow)) {
