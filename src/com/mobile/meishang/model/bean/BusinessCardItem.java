...
public class BusinessCardItem extends Head {
	// {
	// "moduleid": 1,
	// "modulename": "乐汇购",
	...
	public BusinessCardItem(int position,String modulename, int image, int flag) {
	...
	public BusinessCardItem(JSONObject json) throws JSONException {
