...
public class MyWordsListviewAdapter extends BaseCacheListAdapter<GoodsItem> {

	public MyWordsListviewAdapter(Context context) {
		super(context);
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (null == convertView) {
			...
			convertView = mInflater
					.inflate(R.layout.item_lview_my_words, null);
